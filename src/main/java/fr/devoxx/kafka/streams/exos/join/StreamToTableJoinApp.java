...
public class StreamToTableJoinApp {

    private static final String APP_ID = AppUtils.appID("StreamToTableJoin");
    ...
    public static void main(String[] args) {
        ...
        commitsByLogin.print();

        final KTable<String, GithubUser> userWithCommits = commitsByLogin.join(userTable,
                (commit, user) -> user,
                stringSerde, commitSerde
        ).groupByKey(stringSerde, userSerde).reduce((v1, v2) -> v1, "ScalaUserTable");

        userWithCommits.print();
